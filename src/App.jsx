      ...
      <div className="w-full">
        <div className="w-full max-w-md mx-auto border border-gray-60 rounded-lg p-5 backdrop-blur-sm bg-white/30">
          <div className="relative w-full h-5 my-5">
            <h1 className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 border-2 border-white rounded-md bg-blue-600 text-white text-xl px-3 py-2" onClick={swap}>Currency Converter</h1>
          </div>
          <form onSubmit={(e) => {
            e.preventDefault()
            convert()
